...
class Techy
  ...
  def msg
    randomPhrase = (rand * PHRASE_ARR.length).floor
    randomWord = (rand * WORD_ARR.length).floor
    PHRASE_ARR[randomPhrase] + " " + WORD_ARR[randomWord] + " " + WORD_ARR[(rand * WORD_ARR.length).floor];
  rescue Exception => e
    $tx_bot.log e, :red
  end
end
