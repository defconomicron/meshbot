...
class Corporate
  ...
  ADJECTIVES = ['24/7', '24/365', 'accurate', 'adaptive', 'alternative', 'an expanded array of', 'B2B', 'B2C', 'backend',
  ...
  def msg
    [ADVERBS.sample, VERBS.sample, ADJECTIVES.sample, NOUNS.sample].join(' ').capitalize
  end
end
